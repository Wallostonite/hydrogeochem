...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--start", type=date.fromisoformat,
                        default=today.replace(year=today.year - 6),
    ...
    parser.add_argument(
        "--min-required", type=int, default=len(REQUIRED_FOR_SPECIATION),
    ...
    print("Querying the USGS Samples API ...  (live; a whole state can take a minute)",
          file=sys.stderr)
